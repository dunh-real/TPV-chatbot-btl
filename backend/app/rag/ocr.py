...
OCR_PROMPT = (
    ...
    "- Trả về văn bản thường, sạch, dễ đọc. Chỉ dùng Markdown cho BẢNG "
    "(xem mục BẢNG BIỂU); không tô đậm, không in nghiêng, không thêm tiêu đề.\n"
    ...
    "- Bảng biểu: xem mục BẢNG BIỂU bên dưới.\n"
    ...
    "BẢNG BIỂU:\n"
    "- Chỉ khi trên ảnh thật sự có bảng - nghĩa là chữ xếp thành hàng và cột, "
    "thường có đường kẻ hoặc khoảng cách cột đều nhau.\n"
    "- Chép thành bảng Markdown, mỗi hàng một dòng, các ô ngăn bằng dấu |, "
    "và ngay sau hàng tiêu đề là một dòng ngăn cách:\n"
    "  | STT | Tên ngành | Mã ngành |\n"
    "  | --- | --- | --- |\n"
    "  | 1 | Mua bán hàng thuỷ sản | 4620 |\n"
    "- Giữ đúng số cột ở MỌI hàng. Ô trống thì để trống, không bỏ dấu |.\n"
    "- Nội dung một ô dài tràn xuống dòng dưới trên ảnh thì vẫn gộp vào đúng ô "
    "đó, không tách thành hàng mới.\n"
    "- Nếu ô chứa dấu | thì thay bằng dấu gạch chéo / để khỏi vỡ cột.\n"
    "- Văn xuôi, danh sách gạch đầu dòng, phần đầu văn bản KHÔNG phải bảng - "
    "đừng ép chúng thành bảng.\n\n"
